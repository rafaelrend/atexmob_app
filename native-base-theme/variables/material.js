...
//const brandAtex = '#C33764';
const brandAtex = '#1dacd6';
const brandAdvcloud = '#4AC29A';
const brandMartucci = '#a7a954';
...
export default {
  ...
  // Color
  brandAtex: brandAtex,
  brandAdvcloud: brandAdvcloud,
  brandPrimary: brandAtex, // martucci color
  brandSecondary: brandMartucci,
  brandInfo: "#11cdef",
  brandSuccess: "#2dce89",
  brandDanger: "#f5365c",
  brandWarning: "#fb6340",
  ...
  // Other
  borderRadiusBase: defaultBorderRadius,
